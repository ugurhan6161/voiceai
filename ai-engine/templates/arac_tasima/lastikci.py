"""VoiceAI — Lastikçi Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class LastikciSablonu(BaseTemplate):
    KOD = "lastikci"; AD = "Lastikçi"; KATEGORI = "arac_tasima"; IKON = "🔄"
