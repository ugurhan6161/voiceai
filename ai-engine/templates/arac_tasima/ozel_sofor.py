"""VoiceAI — Özel Şoför Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class OzelSoforSablonu(BaseTemplate):
    KOD = "ozelsofor"; AD = "Özel Şoför"; KATEGORI = "arac_tasima"; IKON = "🚖"
    ...
    def get_functions(self) -> list[Fonksiyon]:
        return [
            Fonksiyon("randevu_al", "Randevu veya sipariş oluşturur",
                ...
                ['rezervasyon', 'şoför', 'transfer', 'ulaşım']),
