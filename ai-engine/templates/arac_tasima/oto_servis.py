"""VoiceAI — Oto Servis Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class OtoServisSablonu(BaseTemplate):
    KOD = "otoservis"; AD = "Oto Servis"; KATEGORI = "arac_tasima"; IKON = "🔩"
