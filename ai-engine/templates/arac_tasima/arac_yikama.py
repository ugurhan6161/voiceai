"""VoiceAI — Araç Yıkama Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class AracYikamaSablonu(BaseTemplate):
    KOD = "aracyikama"; AD = "Araç Yıkama"; KATEGORI = "arac_tasima"; IKON = "🚿"
