"""VoiceAI — Araç Kiralama Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class AracKiralamaSablonu(BaseTemplate):
    KOD = "arackiralama"; AD = "Araç Kiralama"; KATEGORI = "arac_tasima"; IKON = "🚗"
...
Araç kiralama rezervasyonu alır.
    ...
    def get_functions(self) -> list[Fonksiyon]:
        return [
            Fonksiyon("randevu_al", "Randevu veya sipariş oluşturur",
                ...
                ['kiralama', 'araç', 'araba', 'rezervasyon']),
