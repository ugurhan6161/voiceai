"""VoiceAI — Kuaför / Berber Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class KuaforBerberSablonu(BaseTemplate):
    KOD = "kuaforberber"; AD = "Kuaför / Berber"; KATEGORI = "kisisel_bakim"; IKON = "💈"
...
Kuaför ve berber randevusu alır.
