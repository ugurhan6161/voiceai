"""VoiceAI — Spor Salonu Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class SporSalonuSablonu(BaseTemplate):
    KOD = "sporsalonu"; AD = "Spor Salonu"; KATEGORI = "kisisel_bakim"; IKON = "🏋️"
...
Spor salonu üyelik ve randevu alır.
