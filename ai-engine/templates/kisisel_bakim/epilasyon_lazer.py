"""VoiceAI — Epilasyon / Lazer Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class EpilasyonLazerSablonu(BaseTemplate):
    KOD = "epilasyonlazer"; AD = "Epilasyon / Lazer"; KATEGORI = "kisisel_bakim"; IKON = "✨"
...
Epilasyon ve lazer randevusu alır.
