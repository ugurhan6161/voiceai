"""VoiceAI — Muhasebe Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class MuhasebeSablonu(BaseTemplate):
    KOD = "muhasebe"; AD = "Muhasebe"; KATEGORI = "egitim_danismanlik"; IKON = "📊"
...
Muhasebe danışma randevusu alır.
    ...
    def get_functions(self) -> list[Fonksiyon]:
        return [
            Fonksiyon("randevu_al", "Randevu veya sipariş oluşturur",
                ...
                ['randevu', 'muhasebe', 'vergi', 'danışma']),
