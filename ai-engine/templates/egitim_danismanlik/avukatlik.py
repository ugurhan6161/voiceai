"""VoiceAI — Avukatlık Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class AvukatlikSablonu(BaseTemplate):
    KOD = "avukatlik"; AD = "Avukatlık"; KATEGORI = "egitim_danismanlik"; IKON = "⚖️"
...
Avukatlık danışma randevusu alır.
