"""VoiceAI — Özel Ders Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class OzelDersSablonu(BaseTemplate):
    KOD = "ozelders"; AD = "Özel Ders"; KATEGORI = "egitim_danismanlik"; IKON = "📚"
