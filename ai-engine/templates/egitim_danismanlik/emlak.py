"""VoiceAI — Emlak Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class EmlakSablonu(BaseTemplate):
    KOD = "emlak"; AD = "Emlak"; KATEGORI = "egitim_danismanlik"; IKON = "🏡"
