"""VoiceAI — Müzik Okulu Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class MuzikOkuluSablonu(BaseTemplate):
    KOD = "muzikokulu"; AD = "Müzik Okulu"; KATEGORI = "egitim_danismanlik"; IKON = "🎵"
