"""VoiceAI — Tesisatçı Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class TesisatciSablonu(BaseTemplate):
    KOD = "tesisatci"; AD = "Tesisatçı"; KATEGORI = "enerji_temel"; IKON = "🔧"
