"""VoiceAI — Elektrikçi Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class ElektrikciSablonu(BaseTemplate):
    KOD = "elektrikci"; AD = "Elektrikçi"; KATEGORI = "enerji_temel"; IKON = "⚡"
