"""VoiceAI — Isıtma / Klima Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class IsitmaKlimaSablonu(BaseTemplate):
    KOD = "isitmaklima"; AD = "Isıtma / Klima"; KATEGORI = "enerji_temel"; IKON = "❄️"
...
Isıtma ve klima servis randevusu alır.
