"""VoiceAI — PVC / Cam Usta Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class PvcCamUstaSablonu(BaseTemplate):
    KOD = "pvccamusta"; AD = "PVC / Cam Usta"; KATEGORI = "ev_hizmetleri"; IKON = "🪟"
...
PVC ve cam usta randevusu alır.
