"""VoiceAI — Ev Tamircisi Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class EvTamircisiSablonu(BaseTemplate):
    KOD = "evtamircisi"; AD = "Ev Tamircisi"; KATEGORI = "ev_hizmetleri"; IKON = "🔧"
...
Ev tamir ve bakım randevusu alır.
