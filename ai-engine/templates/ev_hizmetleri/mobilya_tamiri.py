"""VoiceAI — Mobilya Tamiri Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class MobilyaTamiriSablonu(BaseTemplate):
    KOD = "mobilyatamiri"; AD = "Mobilya Tamiri"; KATEGORI = "ev_hizmetleri"; IKON = "🪑"
