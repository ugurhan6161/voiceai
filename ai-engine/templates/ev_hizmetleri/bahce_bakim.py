"""VoiceAI — Bahçe Bakım Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class BahceBakimSablonu(BaseTemplate):
    KOD = "bahcebakim"; AD = "Bahçe Bakım"; KATEGORI = "ev_hizmetleri"; IKON = "🌿"
