"""VoiceAI — Fotoğraf Stüdyo Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class FotografStudyoSablonu(BaseTemplate):
    KOD = "fotografstudyo"; AD = "Fotoğraf Stüdyo"; KATEGORI = "ozel_hizmetler"; IKON = "📷"
...
Fotoğraf çekimi randevusu alır.
