"""VoiceAI — Organizasyon Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class OrganizasyonSablonu(BaseTemplate):
    KOD = "organizasyon"; AD = "Organizasyon"; KATEGORI = "ozel_hizmetler"; IKON = "🎉"
...
Organizasyon planlama randevusu alır.
    ...
    def get_functions(self) -> list[Fonksiyon]:
        return [
            Fonksiyon("randevu_al", "Randevu veya sipariş oluşturur",
                ...
                ['randevu', 'organizasyon', 'düğün', 'etkinlik']),
