"""VoiceAI — Özel Şablon Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class OzelSablonSablonu(BaseTemplate):
    KOD = "ozelsablon"; AD = "Özel Şablon"; KATEGORI = "ozel_hizmetler"; IKON = "⭐"
...
Özelleştirilebilir genel şablon.
