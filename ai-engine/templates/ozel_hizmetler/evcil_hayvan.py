"""VoiceAI — Evcil Hayvan Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class EvcilHayvanSablonu(BaseTemplate):
    KOD = "evcilhayvan"; AD = "Evcil Hayvan"; KATEGORI = "ozel_hizmetler"; IKON = "🐕"
...
Evcil hayvan bakım randevusu alır.
