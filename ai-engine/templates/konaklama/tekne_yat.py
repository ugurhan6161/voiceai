"""VoiceAI — Tekne / Yat Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class TekneYatSablonu(BaseTemplate):
    KOD = "tekneyat"; AD = "Tekne / Yat"; KATEGORI = "konaklama"; IKON = "⛵"
...
Tekne ve yat kiralama rezervasyonu alır.
