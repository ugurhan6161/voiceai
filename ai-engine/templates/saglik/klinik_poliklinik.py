"""VoiceAI — Klinik / Poliklinik Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class KlinikPoliklinikSablonu(BaseTemplate):
    KOD = "klinikpoliklinik"; AD = "Klinik / Poliklinik"; KATEGORI = "saglik"; IKON = "🏥"
...
Randevu alır, doktor bilgisi verir, hasta kaydı yapar.
