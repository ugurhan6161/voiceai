"""VoiceAI — Spa / Masaj Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class SpaMasajSablonu(BaseTemplate):
    KOD = "spamasaj"; AD = "Spa / Masaj"; KATEGORI = "saglik"; IKON = "💆"
