"""VoiceAI — Göz Kliniği Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class GozKlinigiSablonu(BaseTemplate):
    KOD = "gozklinigi"; AD = "Göz Kliniği"; KATEGORI = "saglik"; IKON = "👁️"
