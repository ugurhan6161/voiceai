"""VoiceAI — Eczane Şablonu"""
from templates.base_template import BaseTemplate, Slot, Fonksiyon


class EczaneSablonu(BaseTemplate):
    KOD = "eczane"; AD = "Eczane"; KATEGORI = "saglik"; IKON = "💊"
...
İlaç bilgisi verir, sipariş alır.
